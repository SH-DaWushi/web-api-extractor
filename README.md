...
- [快速开始](#快速开始)
- [典型使用流程](#典型使用流程)
  - [方式 1：Agent 作为主调度器（正确主路径）](#方式-1agent-作为主调度器正确主路径)
  - [方式 2：已登录站点](#方式-2已登录站点)
  - [方式 3：底层 MCP 工具链调用（仅作为执行接口）](#方式-3底层-mcp-工具链调用仅作为执行接口)
- [关键模块说明](#关键模块说明)
- [数据目录说明](#数据目录说明)
- [这是 Skill，还是 MCP？](#这是-skill还是-mcp)
- [适合的使用姿势](#适合的使用姿势)
- [关键设计判断](#关键设计判断)
- [注意事项](#注意事项)
- [结论](#结论)
